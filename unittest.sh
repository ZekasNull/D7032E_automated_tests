...
echo "Running requirement failure file..."
java -javaagent:./lib/jacocoagent.jar -cp ./lib/org.junit4-4.3.1.jar${SEP}./bin org.junit.runner.JUnitCore ltu.RequirementTest
